  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gray-100 py-16">
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-2xl">
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-8">Submit Car Listing</h2>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label htmlFor="bodyType" className="block text-gray-700 font-semibold">Body Type</label>
            <select
              id="bodyType"
              name="bodyType"
          ...
          {/* Dropdown for Fuel */}
          <div>
            <label htmlFor="fuel" className="block text-gray-700 font-semibold">Fuel Type</label>
            <select
              id="fuel"
              name="fuel"
              value={formData.fuel}
          ...
          <div>
            <label htmlFor="mileage" className="block text-gray-700 font-semibold">Mileage</label>
            <input
              type="number"
              id="mileage"
              name="mileage"
          ...
          <div>
            <label htmlFor="transmission" className="block text-gray-700 font-semibold">Transmission</label>
            <select
              id="transmission"
              name="transmission"
