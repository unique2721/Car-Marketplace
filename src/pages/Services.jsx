      ...
      <section className="py-16 bg-white" id="services">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
            {/* Service 1 */}
            <div className="service-card p-6 bg-gray-50 rounded-lg shadow-lg hover:bg-blue-50 transition duration-300">
      ...
      <section className="py-16 bg-gray-100" id="testimonials">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-12">
            {/* Testimonial 1 */}
            <div className="testimonial p-8 bg-white rounded-lg shadow-lg w-80">
